...
6. 模拟AI输出事实、解释、假设、知识依据与应答。
7. 采用AI结果后生成应答；放弃后不生成。
8. 停用账号后，旧页面下一次请求立即失败。
9. 教研员可完成观察质量审核与导出审批，教师无审批权限。
10. 教研活动进行中教师可提交独立记录，结束后停止提交。
11. 采用AI建议后可实施应答、填写复察证据并进入成长轨迹。
12. 报告仅汇总已采用证据，课程线索可回链多幼儿、多时间点观察。
