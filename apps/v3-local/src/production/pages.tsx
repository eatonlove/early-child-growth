    ...
    <div className="page remote-page">
      ...
      <div className="remote-principle">
        ...
        <div>
          ...
          <p>
            AI不会覆盖教师的观察、识别和应答；图片、视频和PDF作为补充证据。当前模拟AI不读取视频像素或音轨。
          </p>
        </div>
      </div>
          ...
          <div className="detail-stack">
            ...
            {!latest && (
              <Panel className="remote-ai-launch">
                <Sparkles />
                <div>
                  <Badge tone="purple">模拟 AI</Badge>
                  <h2>让AI结合年龄段知识库提供第二视角</h2>
                  <p>
                    输入包含教师原稿、班级年龄、游戏情境和已确认媒体元数据。当前不会读取真实视频内容。
                  </p>
                </div>
                <button
                  disabled={busy}
    ...
    <div className="detail-stack">
      <Panel>
        <div className="remote-analysis-head">
          <div>
            <Badge tone="purple">模拟AI建议稿</Badge>
            <h2>结构化循证分析</h2>
            <p>
              知识版本 {analysis.knowledge_version} · 证据充分性：
