...
function ChildrenImportModal({ onClose }: { onClose: () => void }) {
  ...
  const downloadTemplate = () => {
    ...
    const anchor = document.createElement("a"); anchor.href = url; anchor.download = "童迹3.0幼儿导入模板.csv"; anchor.click(); URL.revokeObjectURL(url);
  };
